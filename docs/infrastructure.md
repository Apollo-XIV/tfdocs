...
The autoscaling group is configured with alarms that cause the number of instances to scale up and down based on the average CPU utilisation of the instances.
...
The dashboard collects a range of different information from the S3 buckets, Load Balancer, and Autoscaling Group.
